...
![Static Badge](https://img.shields.io/badge/CUDA-12.6-green)
...
The code contained in this repository was developed and tested on *Linux* (Ubuntu 22.04.5 LTS), *Python 3.10.12*, and *CUDA 12.6* (the latter is optional).
...
Please directly contact [*João Luzio*](https://sites.google.com/view/joaoluzio) at ```joaoluzio14@tecnico.ulisboa.pt``` for any related question or clarification.